...
QT_MOC_LITERAL(3, 27, 13) // "slotOkClicked"

    },
    "AddFriendDialog\0okClicked\0\0slotOkClicked"
};
...
void AddFriendDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        AddFriendDialog *_t = static_cast<AddFriendDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->okClicked((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->slotOkClicked(); break;
        default: ;
        }
        ...
        {
            typedef void (AddFriendDialog::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AddFriendDialog::okClicked)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject AddFriendDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_AddFriendDialog.data,
      qt_meta_data_AddFriendDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void AddFriendDialog::okClicked(QString _t1)
{
