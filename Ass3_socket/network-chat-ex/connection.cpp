...
Connection::Connection(QObject *parent)
    : QTcpSocket(parent)
{   
    // These are for a mini protocol of sorts
    ...
    // Connected or disconnecte signal is emiited by qTcSocket
    // so is readyRead.
...
/* This is what is used to write the message to the TCP socket */
